const APP_CONFIG = {
    ...
    mergeimals: "Mergeimals: Shoot & Merge"
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('[data-app-name]').forEach(el => {
        ...
        if (APP_CONFIG[appKey]) {
            ...
            if (el.tagName === 'IMG') {
                ...
                if (!el.alt || el.alt === "Climbing" || el.alt === "Gravity Flip" || el.alt === "Mergeimals") {
                    el.alt = appName;
                }
    ...
    if (bodyAppKey && APP_CONFIG[bodyAppKey]) {
        ...
        document.querySelectorAll('strong').forEach(strong => {
            if (APP_CONFIG[bodyAppKey] && (strong.textContent === "Climbing" || strong.textContent === "Gravity Flip" || strong.textContent === "Mergeimals" || strong.textContent === "Ninja Cat Tower")) {
